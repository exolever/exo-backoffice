    ...
    events: {
      'click .close': function(event) {
        ...
        if (this.options.content && this.options.content.trigger) {
          this.options.content.$el.trigger('cancel', this);
        }
      },
      ...
      'click .ok': function(event) {
        ...
        if (this.options.content && this.options.content.trigger) {
          this.options.content.$el.trigger('ok', this);

        }
        if (this.options.content.is_valid){
          var is_valid = this.options.content.is_valid();
          if (is_valid === false){
            return;
          }
        }
